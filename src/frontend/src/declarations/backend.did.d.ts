...
export interface _SERVICE {
  ...
  'addExpenseCategory' : ActorMethod<[ExpenseCategory], undefined>,
  'addTaxRate' : ActorMethod<[TaxRate], undefined>,
  'assignCallerUserRole' : ActorMethod<[Principal, UserRole], undefined>,
  'createExpense' : ActorMethod<[Expense], Expense>,
  'createInvoice' : ActorMethod<[Invoice], Invoice>,
  ...
  'getExpenseCategories' : ActorMethod<[], Array<ExpenseCategory>>,
  'getInvoice' : ActorMethod<[string], [] | [Invoice]>,
  'getProfile' : ActorMethod<[], [] | [UserProfile]>,
  'getTaxRates' : ActorMethod<[], Array<TaxRate>>,
